...
<body>
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="contact-info">
                            ...
                            <div class="content">
                                ...
                                <a
                                    href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#3d55585151527d575c485349135e5250"><span
                                        class="__cf_email__"
                                        data-cfemail="2149444d4d4e614b40544f550f424e4c">[email&#160;protected]</span></a>
                            </div>
                            <div class="content">
                                <i class="bx bx-map"></i>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu">
                            <ul class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a href="#" class="nav-link toggle">Home<i
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link toggle active">Pages<i
                                            class="bx bxs-chevron-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="destination-details.html" class="nav-link">Destinations
                                                Details</a>
                                        </li>
                                    </ul>
                                </li>
    ...
    <div class="page-title-area ptb-100">
        ...
        <div class="bg-image">
            <img src="assets/img/page-title-area/cart.jpg" alt="Demo Image">
        </div>
    </div>
                            ...
                            <tbody>
                                <tr class="product-row">
                                    <td class="product-col">
                                        <figure class="product-image-container">
                                            <a href="blog-details.html" class="product-image">
                                                <img src="assets/img/cart1.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <h3 class="product-title">
                                            <a href="blog-details.html">Asia Tour</a>
                                        </h3>
                                    </td>
                                    <td>$17.90</td>
                                    <td>
                                ...
                                <tr class="product-row">
                                    <td class="product-col">
                                        <figure class="product-image-container">
                                            <a href="blog-details.html" class="product-image">
                                                <img src="assets/img/cart2.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <h3 class="product-title">
                                            <a href="blog-details.html">Brazil Tour</a>
                                        </h3>
                                    </td>
                                    <td>$8.90</td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="4" class="clearfix">
                                        <div class="float-left">
                                            <a href="blog-details.html" class="btn btn-outline-secondary">Continue
                                                Shopping</a>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="col-lg-4">
                    <div class="cart-summary">
                        ...
                        <div class="checkout-methods">
                            <a href="blog-details.html" class="btn btn-block btn-sm btn-primary">Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-5 col-sm-6 col-12">
                        <div class="footer-widget">
                            ...
                            <div class="contact-info">
                                ...
                                <div class="content">
                                    <a
                                        href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#9ff7faf3f3f0dff5feeaf1ebb1fcf0f2"><i
                                            class="bx bx-envelope"></i><span class="__cf_email__"
                                            data-cfemail="2048454c4c4f604a41554e540e434f4d">[email&#160;protected]</span></a>
                                </div>
                                <div class="content">
            ...
            <div class="copy-right-area">
                <div class="container">
                    <div class="copy-right-content">
                        <p>© <span>Jaunt</span> is Proudly Owned by <a href="https://hibootstrap.com/"
...
<!-- Mirrored from templates.hibootstrap.com/jaunt/default/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Aug 2024 14:22:35 GMT -->
